...
docker_compose_modifications = {
    "docker-compose.yml": [
        ...
        (r'sqlms.datasources.\[0\].password=PASSWORD', f'sqlms.datasources.[0].password={resql_db_password}'),
        ...
        (r'sqlms.datasources.\[0\].password=PASSWORD', f'sqlms.datasources.[0].password={resql_users_db_password}'),
        ...
        (r'- POSTGRES_PASSWORD=PASSWORD', f'- POSTGRES_PASSWORD={postgres_password}'),
